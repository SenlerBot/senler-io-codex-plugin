...
- `Покажи текущий проект Senler.io` — покажет название и ID подключённого проекта;
- `Смени проект Senler.io` — отключит текущий проект после подтверждения и запустит OAuth для выбора другого;
